...
public:
    ...
    /// options.
    ///
    /// In the case of facets, the size is constant for all facets of the
    /// output array but triangles may sometimes be generated in 4-sided
    /// facets with non-uniform tessellation rates (quad-preservation
    /// reduces but does not eliminate all triangles). Such triangles are
    /// indicated by the use of an invalid/negative index in the fourth
    /// position.
    ///
...
public:
    ...
    ///
    /// When using facets of size 4, triangles may sometimes be generated
    /// and are indicated by the use of an invalid/negative index in the
    /// fourth position.
    ///
